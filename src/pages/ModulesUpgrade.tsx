import { Puzzle, DollarSign, Users, FileBarChart, ImageDown, MapPinned, ArrowLeft, CheckCircle2, Sparkles } from "lucide-react";
...
export default function ModulesUpgrade() {
  ...
  const handleRequest = (mod: ModuleInfo) => {
    toast.info(`Solicitação de "${mod.label}" registrada! Em breve a ativação estará disponível.`);
  };
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    {active ? (
                      ...
                      >
                        <Sparkles className="h-3.5 w-3.5" /> Solicitar ativação
                      </Button>
                    )}
                  </div>
                </div>
